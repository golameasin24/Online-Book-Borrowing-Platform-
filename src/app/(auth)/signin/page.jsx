...
const Login = () => {
  ...
  return (
    <div className="flex h-screen container mx-auto mt-10 items-center justify-center">
      {/* flex-row-reverse ব্যবহার করে ইমেজ বামে এবং ফর্ম ডানে আনা হয়েছে */}
      <div className="flex h-full w-full flex-row-reverse">
        {/* ফর্ম সেকশন (এখন ডান পাশে দেখাবে) */}
        ...
        {/* ইমেজ সেকশন (এখন বাম পাশে দেখাবে এবং বর্ডার ডান পাশে শিফট করা হয়েছে) */}
