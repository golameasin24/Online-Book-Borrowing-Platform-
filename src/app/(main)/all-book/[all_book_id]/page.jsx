...
const AllBooks = async ({ params }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 container mx-auto gap-4 p-4">
      <div className="col-span-12 md:col-span-3">
        <LeftSideBar Active={all_book_id} category={categoryData} />
      </div>

      <div className="col-span-12 md:col-span-9 grid grid-cols-3 gap-3 p-4 rounded-lg">
